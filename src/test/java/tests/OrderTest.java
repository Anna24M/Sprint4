        ...
        return new Object[][]{
                {
                        ...
                        "Анна", "Иванова", "ул. Шухова д 14", "Кожуховская", "81234567899",
                        "10.01.26", "трое суток", new String[]{"black"}, "позвонить заранее"
                },
                {
                        "down",  //Параметр для выбора кнопки
                        "Вася", "Попов", "ул. Новоорловская д 12", "Комсомольская", "89876543211",
                        "04.01.26", "сутки", new String[]{"grey"}, "скорее"
                }
        };
    }
